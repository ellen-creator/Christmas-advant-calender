...
const modalMessageList = [
    ...
    {"number" : 15, "message" : "오빠와 보내는 크리스마스는 세상에서 제일 사랑스러울거야."},
    {"number" : 16, "message" : "나의 사랑이 오빠의 길에 가로등처럼 불을 밝혀줬음 해 ."},
    {"number" : 17, "message" : "사랑하는 마음이 모여 눈사람을 만든다면, 기네스북에 등재될거야."},
    {"number" : 18, "message" : "오빠를 생각하면 눈처럼 포근함이 몰려와."},
    {"number" : 19, "message" : "언제나 말하며 웃을게 '보고있는데도 보고싶다'고."},
    {"number" : 20, "message" : "삐빅, 이제 그만하고 밥 챙겨먹을 시간이야."},
    {"number" : 21, "message" : "아마 지구 밖을 나서도 내 사랑만은 진하게 보일걸?"},
    {"number" : 22, "message" : "보고싶어. 어찌 매순간 이리도 보고싶을까."},
    {"number" : 23, "message" : "내일을 기다리는 나의 마음은 벌써 행복으로 감싸져있어."},
    {"number" : 24, "message" : "나와 함께한 오늘 어땠어? 매일이 앞으로 이랬으면 좋겠다."}
];
